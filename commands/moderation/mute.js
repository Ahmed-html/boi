...
module.exports.run = async (client, message, args) => {
	...
	const notice3 = new Discord.MessageEmbed()
		.setDescription(`:x: I don't have permission to mute people!`)
		.setColor("RED");
	...
	const sdfsdfsdfsssd = new Discord.MessageEmbed()
		.setDescription(`:x: Type how long u want to mute them for!`)
		.setColor("RED");
	const dddfs = new Discord.MessageEmbed()
		.setDescription(
			":x: You can only mute a user for a maximum of 14 days, just use: `!kick`"
		)
		.setColor("RED");
