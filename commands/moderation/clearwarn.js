...
module.exports.run = async (client, message, args) => {
	...
	const notice3 = new Discord.MessageEmbed()
		.setDescription(`:x: I don't have permission to warn people!`)
		.setColor("RED");
	const noticEEEe2 = new Discord.MessageEmbed()
		.setDescription(
			`:x: You must mention someone to clear their warns!`
		)
		.setColor("RED");
	const noticEffEEe2 = new Discord.MessageEmbed()
		.setDescription(`:x: This user didn't have any warning record!`)
		.setColor("RED");
